 ...
 echo $rsift;?>
            ...
            <td width="21%"><table width="100%" border="0" class="table-list1">
              <tr>
                ...
                <td width="47%" scope="col">19-22</td>
              </tr>
              <tr>
                <td>No. Revisi</td>
                <td>:</td>
      ...
      <tr align="center" bgcolor="#CCCCCC">
        ...
        <td rowspan="3" bgcolor="#F5F5F5" style="width:1.5in;">Item.</td>
...
$rowdb2 = db2_fetch_assoc($stmt);
  ...
  ?>
    ...
    <table width="100%" border="0" class="table-list1">
      ...
      <tr align="center">
        <td>&nbsp;</td>
        <td colspan="-1">Diserahkan Oleh :</td>
        <td>Diketahui Oleh :</td>
      </tr>
      <tr>
        <td>Nama</td>
        <td colspan="-1" align="center"><input type=text name=nama placeholder="Ketik disini"></td>
        <td colspan="-1" align="center"><input type=text name=nama1 placeholder="Ketik disini"></td>
      </tr>
      <tr>
        <td>Jabatan</td>
        <td colspan="-1" align="center"><input type=text name=nama2 placeholder="Ketik disini"></td>
        <td colspan="-1" align="center"><input type=text name=nama3 placeholder="Ketik disini"></td>
      </tr>
      <tr>
        <td>Tanggal</td>
